...
- Blockchain Developer: smart contracts, presale systems, WalletConnect flows, token logic, cross-chain integrations, DeFi mechanics.
- Frontend Engineer: React/Next.js apps, reusable UI architecture, state management, SEO/performance, production releases.
- Full-Stack Engineer: APIs, scheduling systems, transaction workflows, backend validation, dashboard analytics.
- Senior Data Engineer: Kafka streaming, ETL orchestration, dimensional modeling, cloud warehouses, BI enablement.
...
<p>
  ...
  <img src="https://img.shields.io/badge/Nuxt-002E3B?style=flat&logo=nuxt&logoColor=00DC82" />
  <img src="https://img.shields.io/badge/Angular-DD0031?style=flat&logo=angular&logoColor=white" />
  <img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat&logo=typescript&logoColor=white" />
  <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black" />
  <img src="https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat&logo=tailwindcss&logoColor=white" />
  <img src="https://img.shields.io/badge/Redux-764ABC?style=flat&logo=redux&logoColor=white" />
  <img src="https://img.shields.io/badge/Zustand-111111?style=flat" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/EVM-Chains-3C3C3D?style=flat&logo=ethereum&logoColor=white" />
  <img src="https://img.shields.io/badge/Hardhat-FFF100?style=flat&logo=ethereum&logoColor=black" />
  ...
  <img src="https://img.shields.io/badge/NFT-121D33?style=flat" />
  <img src="https://img.shields.io/badge/Token_Launches-0F766E?style=flat" />
  <img src="https://img.shields.io/badge/Slither-Security_Audits-6B7280?style=flat" />
</p>
...
- DeFi products, token systems, and smart contract security best practices.
- Web3 UX: wallet flows, transaction states, and onboarding clarity for real users.
- AI + Web3 integrations: contract analysis tooling, data-backed automation, and workflow assistants.
- Web3 game and NFT-oriented mechanics (minting, distribution, and on-chain interaction patterns).
- Real-time + batch data platforms for product analytics and operations.

## Selected Professional Timeline

- `2025 - Present`: Solo Founder/Engineer at `SteadyStake` (Base DCA product, non-custodial automation).
- `2024 - 2025`: Co-Founder/Engineer at `Shezmu` (token sale platform, WalletConnect 2.0, on-chain payment flows).
- `2022 - 2023`: Senior Frontend/Full-Stack Engineer at `Unore` (reusable components, secure integrations, production delivery).
- `2021 - 2022`: Frontend/Full-Stack Developer at `Croxswap` (DeFi UI, release execution, team leadership).
- `2016 - Present`: Data engineering experience across streaming, ETL, warehousing, and BI systems.
...
- Blockchain and DeFi protocol development
